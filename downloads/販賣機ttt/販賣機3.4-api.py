...
if clientID != -1:
    ...
    while True:
        ...
        if keyboard.is_pressed("1"):
            vrep.simxSetJointTargetVelocity(clientID,SP1_handle,10000,opmode)
        
            #keyboard "2" 
        if keyboard.is_pressed("2"):
            vrep.simxSetJointTargetVelocity(clientID,SP2_handle,10000,opmode)
            
        
        #keyboard "3" 
        if keyboard.is_pressed("3"):
            vrep.simxSetJointTargetVelocity(clientID,SP3_handle,10000,opmode)
            
        #keyboard "4" 
        if keyboard.is_pressed("4"):
            vrep.simxSetJointTargetVelocity(clientID,SP4_handle,10000,opmode)
        
        #keyboard "5" 
        if keyboard.is_pressed("5"):
            vrep.simxSetJointTargetVelocity(clientID,SP5_handle,10000,opmode)
            
        
        #keyboard "6" 
        if keyboard.is_pressed("6"):
            vrep.simxSetJointTargetVelocity(clientID,SP6_handle,10000,opmode)
            
        
        #keyboard "7" 
        if keyboard.is_pressed("7"):
            vrep.simxSetJointTargetVelocity(clientID,SP7_handle,10000,opmode)
            
        
        #keyboard "8" 
        if keyboard.is_pressed("8"):
            vrep.simxSetJointTargetVelocity(clientID,SP8_handle,10000,opmode)
        
        #keyboard "9" 
        if keyboard.is_pressed("9"):
            vrep.simxSetJointTargetVelocity(clientID,SP9_handle,10000,opmode)
